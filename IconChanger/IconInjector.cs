...
{
    /// <summary>
    /// Credit to quasar - using IconInjector from QuasarRAT project
    /// original last updated May 5 2015
    /// modified by me Feb 20 2017
    ...
    public static class IconInjector
    {
        ...
        public static void InjectIconFromFile(string exeFileName, string iconFileName)
        {
            InjectIconFromFile(exeFileName, iconFileName, 1, 1);
        }

        public static void InjectIconFromFile(string exeFileName, string iconFileName, uint iconGroupID, uint iconBaseID)
        {
            IconFile iconFile = IconFile.FromFile(iconFileName);
            InjectIcon(exeFileName, iconFile, iconGroupID, iconBaseID);
        }

        public static void InjectIconFromResource(string exeFileName, Icon icon)
        {
            InjectIconFromResource(exeFileName, icon, 1, 1);
        }

        public static void InjectIconFromResource(string exeFileName, Icon icon, uint iconGroupID, uint iconBaseID)
        {
            IconFile iconFile = IconFile.FromResource(icon);
            InjectIcon(exeFileName, iconFile, iconGroupID, iconBaseID);
        }

        private static void InjectIcon(string exeFileName, IconFile iconFile, uint iconGroupID, uint iconBaseID)
        {
        ...
        private class IconFile
        {
            ...
            public static IconFile FromResource(Icon resource)
            {
                byte[] fileBytes;
            ...
            private static IconFile FromBytes(byte[] fileBytes)
            {
